        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800 mb-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">Evalúa tu rendimiento actual en 10 áreas clave para identificar oportunidades de mejora y crear un plan personalizado de desarrollo.</p>
              <button
